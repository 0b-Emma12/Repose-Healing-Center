    ...
    <div class="grid gap-12 lg:grid-cols-4 lg:gap-8">
      ...
      <div class="lg:col-span-1">
        ...
        <div class="mt-8 flex gap-5">
          <!-- Social Icons -->
          <a href="https://www.facebook.com/ligi.nghopefully26/" target="_blank" rel="noopener" class="text-slate-400 transition hover:text-yellow-500">
          ...
          <a href="https://www.tiktok.com/@livi.hope26" target="_blank" rel="noopener" class="text-slate-400 transition hover:text-yellow-500">
            <span class="sr-only">TikTok</span>
            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
              <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-2.88 2.5 2.89 2.89 0 0 1-2.89-2.89 2.89 2.89 0 0 1 2.89-2.89c.28 0 .54.04.79.1V9.01a6.32 6.32 0 0 0-.79-.05 6.34 6.34 0 0 0-6.34 6.34 6.34 6.34 0 0 0 6.34 6.34 6.34 6.34 0 0 0 6.33-6.34V8.69a8.18 8.18 0 0 0 4.78 1.52V6.75a4.85 4.85 0 0 1-1.01-.06z"/>
            </svg>
          </a>
          <a href="https://www.instagram.com/livi.nghope26/" target="_blank" rel="noopener" class="text-slate-400 transition hover:text-yellow-500">
      ...
      <div>
        ...
        <ul class="mt-6 space-y-4 text-sm text-slate-400">
          <li class="flex items-start gap-3">
            ...
            <span>Nkumba Bufulu, Entebbe, Uganda</span>
          </li>
          ...
          <li class="flex items-center gap-3">
            ...
            <a href="mailto:info@reposehealingcenter.com" class="break-all transition hover:text-yellow-500">info@reposehealingcenter.com</a>
          </li>
        </ul>
      </div>
