...
return [
    'conditions' => [
        'depression' => [
            ...
            'description' => 'Comprehensive, compassionate care for individuals struggling with depressive disorders.',
            'content' => '
                <h2>Understanding Depression</h2>
                <p>Depression is more than just feeling sad or going through a rough patch. It is a serious mental health condition that requires understanding and professional care. Symptoms can vary widely but often include persistent feelings of sadness, loss of interest in activities, changes in appetite, and difficulty sleeping.</p>
                <h3>How We Help</h3>
                <p>At Repose Healing Center, we utilise evidence-based therapeutic interventions including Cognitive Behavioural Therapy (CBT), individual counselling, and when necessary, psychiatric support. Our holistic approach ensures that we address the root causes of depression, helping you build resilience and rediscover joy in daily life.</p>
                <ul>
                    <li>Thorough clinical assessment and diagnosis</li>
                    <li>Personalised one-to-one therapy sessions</li>
                    <li>Group support and psycho-education</li>
                    <li>Holistic wellness practices (mindfulness, art therapy)</li>
                </ul>
            ',
        ],
        'anxiety' => [
            ...
            'eyebrow' => 'MENTAL HEALTH',
            'description' => 'Evidence-based treatment to help you manage anxiety, panic attacks, and chronic stress.',
            'content' => '
                <h2>Living Free from Anxiety</h2>
                <p>Anxiety disorders are among the most common mental health challenges, presenting as generalised anxiety, panic disorders, social anxiety, or phobias. Constant worry can be debilitating and physically exhausting.</p>
                <h3>Our Treatment Approach</h3>
                <p>We focus on equipping you with practical coping mechanisms to manage anxiety triggers. Through trauma-informed care and CBT, we help you reframe negative thought patterns and regain control of your nervous system.</p>
            ',
        ],
        'trauma-and-ptsd' => [
            'title' => 'Trauma & PTSD',
            'eyebrow' => 'MENTAL HEALTH',
            'description' => 'Safe, trauma-informed care to help you heal from past distressing events.',
            'content' => '
                <h2>Healing from Trauma</h2>
                <p>Trauma leaves a lasting imprint on both the mind and body. Whether resulting from a single incident or prolonged exposure to distressing environments, Post-Traumatic Stress Disorder (PTSD) requires specialised, sensitive care.</p>
                <h3>Trauma-Informed Care</h3>
                <p>Our clinicians are trained in trauma-informed approaches, ensuring that your healing environment feels completely safe. We work at your pace, focusing on emotional regulation and processing traumatic memories in a secure setting.</p>
            ',
        ],
        'alcohol-use' => [
            'title' => 'Alcohol Use Problems',
            'eyebrow' => 'ADDICTION & SUBSTANCE USE',
            'description' => 'Structured, medically supervised rehabilitation for alcohol addiction and dependency.',
            'content' => '
                <h2>Overcoming Alcohol Dependency</h2>
                <p>Alcohol addiction affects every aspect of a person’s life—physical health, relationships, and career. Acknowledging the problem is a brave first step. Recovery requires professional support, medical oversight, and a commitment to change.</p>
                <h3>Our Rehabilitation Process</h3>
                <p>We provide a structured environment to help you safely detox and rebuild your life without alcohol. Our program includes medical detoxification, 12-step facilitation, individual counselling, and intensive relapse prevention planning.</p>
            ',
        ],
        'drug-use' => [
            'title' => 'Drug Use Problems',
            'eyebrow' => 'ADDICTION & SUBSTANCE USE',
            'description' => 'Confidential treatment for dependency on prescription medications and illicit substances.',
            'content' => '
                <h2>Breaking the Cycle of Addiction</h2>
                <p>Substance use disorders change the brain\'s chemistry, making willpower alone insufficient for recovery. We treat addiction to a wide range of substances, providing the medical and psychological support needed to break the cycle.</p>
                <h3>Comprehensive Treatment</h3>
                <p>Our multidisciplinary team provides 24/7 support during the crucial early stages of recovery. We focus on identifying underlying triggers, treating co-occurring mental health issues (Dual Diagnosis), and building a sustainable sober lifestyle.</p>
            ',
        ],
        'dual-diagnosis' => [
            'title' => 'Dual Diagnosis',
            'eyebrow' => 'ADDICTION & SUBSTANCE USE',
            'description' => 'Integrated treatment for co-occurring mental health conditions and substance use disorders.',
            'content' => '
                <h2>Treating the Whole Person</h2>
                <p>Often, individuals use substances to cope with underlying mental health conditions like depression, anxiety, or trauma. This is known as Dual Diagnosis or co-occurring disorders. Treating one without the other significantly increases the risk of relapse.</p>
                <h3>Integrated Care</h3>
                <p>At Repose Healing Center, we treat both the addiction and the mental health condition simultaneously. Our integrated approach ensures that you receive psychiatric care alongside addiction counselling, leading to better, long-lasting outcomes.</p>
            ',
        ],
    ],
